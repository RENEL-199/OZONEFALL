    ...
    for (var j = 0; j < instances_per_cluster; j++) {
        ...
        if (tile_index == LAND_TILE_INDEX) {
            ...
            if (!ds_map_exists(global.grass_tiles, key)) {
                // place grass
                instance_create_layer(final_x, final_y, "Instances_1", idle_bush);
